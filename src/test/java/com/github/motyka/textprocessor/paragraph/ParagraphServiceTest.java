...
public class ParagraphServiceTest {
	...
	public void test() {
		List<Paragraph> paragraphs = service.splitAndSearch("test", "search", 1200, 800);

		System.out.println("test" + paragraphs);
	}
	...
	@Test
	@DisplayName("single paragraph with whitespaces and punctuation")
	public void paragraphWhitespacesTrailingPunctuation() {
		List<Paragraph> paragraphs = service.splitAndSearch(" \t\n ,!paragraph?, \t\n ", "search", 1200, 800);
	...
	@Test
	@DisplayName("high limit, no separation needed needed")
	...
	public void dotsAndTrailingPunctuations() {
